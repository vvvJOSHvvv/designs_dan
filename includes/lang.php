...
$TRANSLATIONS = [
    'en' => [
        ...
        'contact.form.password' => 'Password (optional)',
        'contact.form.password_hint' => 'Set a password to make this a private post — only you and our staff can view it.',
        'contact.form.submit'  => 'Send Inquiry',
        'contact.form.note'    => '* After sending, you\'ll be taken to your post on the Answers board, where you can check for a reply anytime.',

        // ---- Resources (자료실 패널) ----
        'tab.resources.eyebrow' => 'RESOURCES',
        'tab.resources.title'   => 'Resources',
        'tab.resources.intro'   => 'Download drawings, business cards, print files, and other materials we prepare for you.',

        // ---- Answers board (답변 게시판, 2026-08-14 추가) ----
        'nav.answers' => 'Answers',
        'answers.eyebrow' => 'ANSWERS',
        'answers.title' => 'Answers',
        'answers.intro' => 'Every inquiry sent through our Contact form appears here. Set a password when you write yours to keep it private.',
        'answers.empty' => 'No inquiries yet.',
        'answers.status.pending' => 'Awaiting reply',
        'answers.status.answered' => 'Answered',
        'answers.locked_badge' => 'Private',
        'answers.locked_title' => 'Private inquiry',
        'answers.back_to_list' => '← Back to Answers',
        'answers.back_to_home' => '← Back to home',
        'answers.submitted_banner' => 'Your inquiry has been received. Save this page (or remember the password you set) so you can check for a reply.',
        'answers.password.prompt' => 'This is a private post. Enter the password to view it.',
        'answers.password.label' => 'Password',
        'answers.password.submit' => 'View',
        'answers.password.error' => 'Incorrect password.',
        'answers.password.locked' => 'Too many failed attempts. Please try again in a few minutes.',
        'answers.field.name' => 'Name',
        'answers.field.type' => 'Inquiry Type',
        'answers.field.message' => 'Message',
        'answers.field.date' => 'Date',
        'answers.reply.heading' => 'Reply from DESIGN DAN',
        'answers.reply.quote_heading' => 'Quote',
        'answers.reply.none' => 'We haven\'t replied yet. We usually respond within 1–2 business days.',
        ...
        'admin.login.locked' => 'Too many failed attempts. Please try again in a few minutes.',
        'admin.dashboard.title' => 'Inquiries',
        'admin.dashboard.logout' => 'Log Out',
        'admin.dashboard.view' => 'View →',
        'admin.dashboard.pending_count' => 'Awaiting reply',
        'admin.reply.heading' => 'Write a Reply',
        'admin.reply.message.label' => 'Reply message',
        'admin.reply.quote.label' => 'Quote (optional)',
        'admin.reply.quote.hint' => 'e.g. amount, line items, validity period — shown to the customer as-is.',
        'admin.reply.submit' => 'Post Reply',
        'admin.reply.existing_heading' => 'Previous replies',
        'admin.contact_details' => 'Contact details',
        'admin.setup.title' => 'Create the First Admin Account',
        'admin.setup.note' => 'This page only works once, while there is no admin account yet. After creating your account it disables itself automatically.',
        'admin.setup.submit' => 'Create Account',
        'admin.setup.done' => 'This setup page is no longer available — an admin account already exists.',
        'admin.setup.token_error' => 'Missing or incorrect setup link. Ask whoever gave you this feature for the correct link.',

        // ---- 에러 페이지 / 404 (2026-08-16 추가) ----
        'error.back_home' => '← Back to home',
        'error.db.title' => 'Temporarily unavailable',
        'error.db.desc'  => 'We could not reach our database just now, so this page cannot load. Please try again in a few minutes. If you were sending an inquiry, it was not saved — please resend it.',
        'error.404.title' => 'Page not found',
        'error.404.desc'  => 'The address may be mistyped, or this page may have moved. Please head back to the home page.',
        'error.form.title' => 'Your inquiry was not sent',
        'error.form.required' => 'Name, email and message are all required. Please fill them in and try again.',
        'error.form.rate' => 'Too many inquiries have been sent from your connection recently. Please try again later, or email us directly at designdan2020@gmail.com.',
        'error.form.save' => 'Something went wrong while saving your inquiry, so it was not sent. Please try again in a few minutes, or email us directly at designdan2020@gmail.com.',

        // ---- 개인정보처리방침 / 이용약관 (2026-08-16 추가) ----
        'legal.privacy.title' => 'Privacy Policy',
        'legal.privacy.updated' => 'Last updated: 16 August 2026',
        'legal.privacy.s1.title' => 'What we collect',
        'legal.privacy.s1.body' => 'When you send an inquiry through our contact form, we collect the name, email address, phone number (optional), inquiry type and message you enter. If you set a password to make your post private, we store only a one-way encrypted version of it — never the password itself.',
        'legal.privacy.s2.title' => 'Why we collect it',
        'legal.privacy.s2.body' => 'We use this information solely to respond to your inquiry and to provide the services you ask about. We do not use it for advertising, and we do not sell or share it with third parties.',
        'legal.privacy.s3.title' => 'How long we keep it',
        'legal.privacy.s3.body' => 'Inquiries and our replies are kept while they remain useful for ongoing or future work with you. You may ask us to delete your inquiry at any time and we will remove it.',
        'legal.privacy.s4.title' => 'What is shown publicly',
        'legal.privacy.s4.body' => 'On the Answers board, only a partially masked name (e.g. J***), the inquiry type, the date and the status are shown. Your email address and phone number are never displayed publicly — only our staff can see them. Posts you protect with a password require that password to be read.',
        'legal.privacy.s5.title' => 'Your rights and contact',
        'legal.privacy.s5.body' => 'You may request access to, correction of, or deletion of your information at any time. Contact us at designdan2020@gmail.com and we will act on your request.',

        'legal.terms.title' => 'Terms of Use',
        'legal.terms.updated' => 'Last updated: 16 August 2026',
        'legal.terms.s1.title' => 'About this site',
        'legal.terms.s1.body' => 'This website introduces the architecture, design and business solution services provided by DESIGN DAN, and lets you send inquiries about them.',
        'legal.terms.s2.title' => 'Inquiries and replies',
        'legal.terms.s2.body' => 'Inquiries sent through this site are not a contract in themselves. Scope, schedule and price are agreed separately in writing after we discuss your project. Replies and any figures posted on the Answers board are guidance based on the information given at the time, and may change once the details are confirmed.',
        'legal.terms.s3.title' => 'Using the board appropriately',
        'legal.terms.s3.body' => 'Please do not post content that is unlawful, that infringes someone else\'s rights, that advertises unrelated products, or that contains another person\'s private information. We may remove such posts without notice.',
        'legal.terms.s4.title' => 'Content and downloads',
        'legal.terms.s4.body' => 'Text, images, drawings and files on this site belong to DESIGN DAN or to the client they were produced for. Files provided in the Resources area are for the intended client and purpose only; please do not redistribute them without permission.',
        'legal.terms.s5.title' => 'Availability',
        'legal.terms.s5.body' => 'We aim to keep this site available at all times, but it may be briefly unavailable for maintenance or for reasons outside our control. Contact us at designdan2020@gmail.com with any questions about these terms.',
        ...
        // 2026-08-18: 'footer.staff_login' 키는 삭제했다 — 풋터의 "관리자 로그인" 링크를
        // 없앴기 때문(관리자는 주소창에 /admin 을 직접 입력해서 들어간다).
    ],
    ...
    'ko' => [
        ...
        'contact.form.password' => '비밀번호 (선택)',
        'contact.form.password_hint' => '비밀번호를 입력하면 비공개 글이 됩니다 — 나와 담당자만 볼 수 있어요.',
        'contact.form.submit'  => '문의 보내기',
        'contact.form.note'    => '* 문의를 보내면 답변 게시판의 내 글로 이동합니다. 나중에 그 페이지에서 답변을 확인할 수 있어요.',

        // ---- Resources (자료실 패널) ----
        'tab.resources.eyebrow' => '자료실',
        'tab.resources.title'   => '자료실',
        'tab.resources.intro'   => '도면, 명함, 인쇄 이미지 등 작업해 드린 자료를 이곳에서 다운로드할 수 있습니다.',

        // ---- 답변 게시판 (2026-08-14 추가) ----
        'nav.answers' => '답변',
        'answers.eyebrow' => '답변',
        'answers.title' => '답변',
        'answers.intro' => '문의하기로 보내주신 글이 모두 여기에 모입니다. 글을 쓸 때 비밀번호를 설정하면 비공개로 남길 수 있어요.',
        'answers.empty' => '아직 등록된 문의가 없습니다.',
        'answers.status.pending' => '답변 대기중',
        'answers.status.answered' => '답변 완료',
        'answers.locked_badge' => '비공개',
        'answers.locked_title' => '비공개 문의',
        'answers.back_to_list' => '← 답변 목록으로',
        'answers.back_to_home' => '← 홈으로',
        'answers.submitted_banner' => '문의가 접수되었습니다. 답변을 나중에 확인하려면 이 페이지 주소(또는 설정한 비밀번호)를 기억해 두세요.',
        'answers.password.prompt' => '비공개 글입니다. 비밀번호를 입력해 주세요.',
        'answers.password.label' => '비밀번호',
        'answers.password.submit' => '확인',
        'answers.password.error' => '비밀번호가 일치하지 않습니다.',
        'answers.password.locked' => '너무 많이 실패했습니다. 잠시 후 다시 시도해 주세요.',
        'answers.field.name' => '이름',
        'answers.field.type' => '문의 유형',
        'answers.field.message' => '문의 내용',
        'answers.field.date' => '등록일',
        'answers.reply.heading' => 'DESIGN DAN의 답변',
        'answers.reply.quote_heading' => '견적',
        'answers.reply.none' => '아직 답변이 등록되지 않았습니다. 보통 영업일 기준 1~2일 내에 답변드립니다.',

        // ---- 관리자 (2026-08-14 추가) ----
        'admin.login.title' => '관리자 로그인',
        'admin.login.username' => '아이디',
        'admin.login.password' => '비밀번호',
        'admin.login.submit' => '로그인',
        'admin.login.error' => '아이디 또는 비밀번호가 일치하지 않습니다.',
        'admin.login.locked' => '너무 많이 실패했습니다. 잠시 후 다시 시도해 주세요.',
        'admin.dashboard.title' => '문의 목록',
        'admin.dashboard.logout' => '로그아웃',
        'admin.dashboard.view' => '보기 →',
        'admin.dashboard.pending_count' => '답변 대기',
        'admin.reply.heading' => '답변 작성',
        'admin.reply.message.label' => '답변 내용',
        'admin.reply.quote.label' => '견적 (선택)',
        'admin.reply.quote.hint' => '예: 금액, 항목, 유효기간 등 — 입력한 그대로 고객에게 보여집니다.',
        'admin.reply.submit' => '답변 등록',
        'admin.reply.existing_heading' => '이전 답변',
        'admin.contact_details' => '연락처 정보',
        'admin.setup.title' => '첫 관리자 계정 만들기',
        'admin.setup.note' => '이 페이지는 관리자 계정이 하나도 없을 때만 동작합니다. 계정을 만들면 자동으로 비활성화됩니다.',
        'admin.setup.submit' => '계정 만들기',
        'admin.setup.done' => '이미 관리자 계정이 있어서 이 설정 페이지는 더 이상 사용할 수 없습니다.',
        'admin.setup.token_error' => '설정 링크가 없거나 올바르지 않습니다. 정확한 링크를 다시 확인해 주세요.',

        // ---- 에러 페이지 / 404 (2026-08-16 추가) ----
        'error.back_home' => '← 홈으로 돌아가기',
        'error.db.title' => '일시적으로 이용할 수 없습니다',
        'error.db.desc'  => '지금 데이터를 불러올 수 없어 이 페이지를 표시하지 못했습니다. 몇 분 후 다시 시도해 주세요. 문의를 보내던 중이었다면 저장되지 않았으니 다시 보내주셔야 합니다.',
        'error.404.title' => '페이지를 찾을 수 없습니다',
        'error.404.desc'  => '주소가 잘못 입력되었거나, 페이지가 이동했을 수 있습니다. 홈으로 돌아가서 다시 찾아주세요.',
        'error.form.title' => '문의가 전송되지 않았습니다',
        'error.form.required' => '이름, 이메일, 메시지는 모두 필수 항목입니다. 입력하신 뒤 다시 시도해 주세요.',
        'error.form.rate' => '짧은 시간에 너무 많은 문의가 접수되었습니다. 잠시 후 다시 시도하시거나 designdan2020@gmail.com 으로 직접 보내주세요.',
        'error.form.save' => '문의를 저장하는 중 문제가 생겨 전송되지 않았습니다. 몇 분 후 다시 시도하시거나 designdan2020@gmail.com 으로 직접 보내주세요.',

        // ---- 개인정보처리방침 / 이용약관 (2026-08-16 추가) ----
        'legal.privacy.title' => '개인정보처리방침',
        'legal.privacy.updated' => '최종 개정일: 2026년 8월 16일',
        'legal.privacy.s1.title' => '수집하는 항목',
        'legal.privacy.s1.body' => '문의하기 양식으로 문의를 보내실 때 입력하신 이름, 이메일 주소, 전화번호(선택), 문의 유형, 문의 내용을 수집합니다. 비공개 글로 설정하기 위해 비밀번호를 입력하신 경우, 비밀번호 자체는 저장하지 않고 복호화가 불가능한 형태로 암호화해서만 보관합니다.',
        'legal.privacy.s2.title' => '수집·이용 목적',
        'legal.privacy.s2.body' => '문의에 답변드리고, 문의하신 서비스를 제공하기 위한 목적으로만 이용합니다. 광고 목적으로 이용하지 않으며, 제3자에게 판매하거나 제공하지 않습니다.',
        'legal.privacy.s3.title' => '보유 기간',
        'legal.privacy.s3.body' => '문의 내용과 답변은 진행 중이거나 향후 예정된 업무에 필요한 기간 동안 보관합니다. 언제든지 삭제를 요청하실 수 있으며, 요청 시 지체 없이 삭제합니다.',
        'legal.privacy.s4.title' => '공개되는 정보',
        'legal.privacy.s4.body' => '답변 게시판에는 일부만 가린 이름(예: 홍**), 문의 유형, 등록일, 답변 상태만 표시됩니다. 이메일 주소와 전화번호는 게시판에 전혀 공개되지 않으며 담당자만 확인할 수 있습니다. 비밀번호를 설정한 글은 그 비밀번호를 입력해야 내용을 볼 수 있습니다.',
        'legal.privacy.s5.title' => '이용자의 권리 및 문의처',
        'legal.privacy.s5.body' => '본인의 정보에 대한 열람·정정·삭제를 언제든 요청하실 수 있습니다. designdan2020@gmail.com 으로 연락 주시면 처리해 드립니다.',

        'legal.terms.title' => '이용약관',
        'legal.terms.updated' => '최종 개정일: 2026년 8월 16일',
        'legal.terms.s1.title' => '이 사이트에 대하여',
        'legal.terms.s1.body' => '이 웹사이트는 DESIGN DAN이 제공하는 건축·디자인·비즈니스 솔루션 서비스를 소개하고, 그에 대한 문의를 접수하기 위한 사이트입니다.',
        'legal.terms.s2.title' => '문의와 답변의 효력',
        'legal.terms.s2.body' => '이 사이트를 통해 보내신 문의 자체가 계약이 되는 것은 아닙니다. 업무 범위·일정·금액은 프로젝트 협의 후 별도의 서면으로 확정합니다. 답변 게시판에 게시된 답변이나 금액은 그 시점에 제공된 정보를 기준으로 한 안내이며, 세부 사항이 확정되면 달라질 수 있습니다.',
        'legal.terms.s3.title' => '게시판 이용 시 유의사항',
        'legal.terms.s3.body' => '법령을 위반하는 내용, 타인의 권리를 침해하는 내용, 관련 없는 상품 광고, 타인의 개인정보가 포함된 내용은 게시하지 말아 주세요. 이러한 글은 사전 통보 없이 삭제될 수 있습니다.',
        'legal.terms.s4.title' => '콘텐츠 및 자료 이용',
        'legal.terms.s4.body' => '이 사이트의 문구·이미지·도면·파일은 DESIGN DAN 또는 해당 작업을 의뢰한 고객에게 권리가 있습니다. 자료실에서 제공되는 파일은 해당 고객과 목적에 한해 제공되는 것이므로, 사전 허락 없이 재배포하지 말아 주세요.',
        'legal.terms.s5.title' => '서비스 제공 안정성',
        'legal.terms.s5.body' => '항상 정상적으로 이용할 수 있도록 노력하고 있으나, 점검이나 불가피한 사정으로 일시적으로 접속이 어려울 수 있습니다. 본 약관에 관한 문의는 designdan2020@gmail.com 으로 연락 주세요.',
        ...
        'footer.terms'   => '이용약관',
        // 'footer.staff_login' 삭제 — 위 영어 쪽 주석 참고 (2026-08-18)
    ],
];
